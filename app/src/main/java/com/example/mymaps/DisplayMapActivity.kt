...
class DisplayMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngBounds(boundsBuilder.build(), 900, 900, 0))
//        mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(boundsBuilder.build(), 900, 900, 0))
    }
}